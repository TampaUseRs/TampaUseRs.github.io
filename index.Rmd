...
upcoming <- if (file.exists("upcoming.rds")) {
  message("Loading cached upcoming meetup information")
  readRDS("upcoming.rds")
} else {
  message("Getting up-to-date meetup events from Meetup")
  safely_get_meetup_events <- safely(meetupr::get_events)
  upcoming <- safely_get_meetup_events(trug_url_slug)
  saveRDS(upcoming, "upcoming.rds")
}
```
